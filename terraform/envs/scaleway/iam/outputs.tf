...
output "export_image_builder" {
  ...
  value       = <<-EOT
    export SCW_ACCESS_KEY=$(terraform -chdir=terraform/envs/scaleway/iam output -raw image_builder_access_key)
    export SCW_SECRET_KEY=$(terraform -chdir=terraform/envs/scaleway/iam output -raw image_builder_secret_key)
  EOT
}
...
output "export_cluster" {
  ...
  value       = <<-EOT
    export SCW_ACCESS_KEY=$(terraform -chdir=terraform/envs/scaleway/iam output -raw cluster_access_key)
    export SCW_SECRET_KEY=$(terraform -chdir=terraform/envs/scaleway/iam output -raw cluster_secret_key)
  EOT
}
