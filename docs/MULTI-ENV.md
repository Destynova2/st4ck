...
└── Project "st4ck"                          ← single project, all envs
    ...
    │   ├── st4ck-talos-v1.12.9-{sha7}   (fr-par)
    │   ├── st4ck-talos-v1.12.9-{sha7}   (nl-ams)
    │   └── st4ck-talos-v1.12.9-{sha7}   (pl-waw)
    │
    ...
    subgraph Organization["Scaleway Organization"]
        subgraph Project["Project st4ck"]
            ...
            subgraph ImagesRegion["Images (regional)"]
                IMGFR["st4ck-talos-v1.12.9-abc1234<br/>fr-par"]
                IMGNL["st4ck-talos-v1.12.9-abc1234<br/>nl-ams"]
            end
